    ...
    <v-container>
      ...
      <div class="pagamento">
        <div class="divAvista">
          ...
          <button>
            <a class="black--text" target="_blank" href="https://pay.hotmart.com/W55117628G?off=eufxncec&checkoutMode=10&bid=1625667451319">
              CLIQUE AQUI
            </a>
          </button>
        </div>
...
<style>
  ...
  .linha-vertical {
    ...
    border-left: 2px solid #01FF4E;/* Adiciona borda esquerda na div como ser fosse uma linha.*/
  }
...
@media (max-width:600px){
    ...
    .linha-vertical {
      ...
      width: 400px;
      max-width: 100%;
      border-bottom: 2px solid #01FF4E;/* Adiciona borda esquerda na div como ser fosse uma linha.*/
      margin-top: 50px;
    }
  }
